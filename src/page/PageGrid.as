package page {
	...
	public class PageGrid extends SpriteTemplate implements IReszieChild {
		/**
		 * 可视元素非2维矩阵时,元素横向排列
		 */
		 ...
		 */
		public function PageGrid($SourceGroup:Array,$view_width:Number = 1920,$view_heihgt:Number = 1080,$direction:String = "x",$viewPoint:Point = null,$circleView:Boolean = false,$touch:Boolean = true) {
